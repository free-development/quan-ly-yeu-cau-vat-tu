					...
					<ul>
						...
						<li><a href="">Danh mục</a>
							<ul>
								...
								<li><a href="<%=siteMap.vtManage + "?action=manageCtvt"%>">Danh mục vật tư</a></li>
...
<!-- 								<th class="seven-column">Số lượng tồn</th> -->
	...
	<td class="left-column"><input type="checkbox" name="vtMa" value="<%=vatTu.getVtMa() %>" class="checkbox"></td>
							<td class="col"><%=vatTu.getVtMa() %></td>
							<td class="col"><%=vatTu.getVtTen() %></td>
							<td class="col"><%=vatTu.getDvt() %></td>
							<td><a href="<%=siteMap.ctvtManage + "?action=manageCtvt"%>">Danh mục vật tư chi tiết</a></td>
						</tr>
						<%} }%>
					...
					<div class="group-button">
						...
						<button type="button" class="button" onclick="return confirmDelete()"> <i class="fa fa-trash-o" ></i>&nbsp;&nbsp;Xóa</button>&nbsp;
