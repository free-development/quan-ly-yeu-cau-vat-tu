					...
					<table>
						...
						<tr>
							<th style="text-align: left"><label for="MVT">Tên
									vật tư</label></th>
							<td><input name="vtTen" size="5px" align=right type="text"
				...
				<div class="input-table">
					<table>
						...
						<tr>
							<th style="text-align: left"><label for="MVT">Mã vật
									tư</label></th>
							<td><input name="" size="5px" align=right type="text"
						...
						<tr>
							...
							<th style="text-align: left"><label for="DM">Số
									lượng tồn</label></th>
							<td><input name="" size="5px" align=right type="text"
