...
<!--            <form id="main-form">-->
                <div class="left-content">
                    ...
                    <ol class="tree">
                        <li>
                            <label for="folder1">Năm 2015</label> <input type="checkbox" id="folder1"/> 
                            <ol>
                                <li>
                                    <label for="subfolder1">Tháng 08</label> <input type="checkbox" id="subfolder1" /> 
                                    <ol>
...
<!--                                 <div class="search-form">-->
                                <span class="search-text" >
<!--								&nbsp;-->
				                    <input type="search" class="text" name="search_box" name="search" placeholder="Nội dung tìm kiếm" />
                                </span>
                                <span class="search-button">
							         <button class="btn-search"><i class="fa fa-search" ></i></button>
							     </span>
                        ...
                        <div class="input-table">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <th style="text-align: left;padding-left:20px;"><label for="NG">Nơi gửi</label></th>
                                    <td><select class="select">
                                        <option></option>
                                ...
                                <tr>
                                    ...
                                    <th style="text-align: left;padding-left:20px;"><label for="TN">Từ số</label></th>
                                    <td><select class="select">
                                        <option></option>
                                    ...
                                    <th style="text-align: left;padding-left:20px;"><label for="TS">Từ ngày</label></th>
                                    <td><select class="select">
                                        <option></option>
                                ...
                                <tr>
                                    <th style="text-align: left"><label for="KH">Ký hiệu</label></th>
                                    <td><input name="" size="10px" align=right type="text" class="text" required title=""></td>
<!--
...
-->
                                    ...
                                    <td></td>
                                    <th style="text-align: left;padding-left:20px;"><label for="NK">Ngày ký</label></th>
                                    <td><select class="select">
                                        <option></option>
                                        <option>23/06/2015</option>
                                        </select>
...
-->
                            ...
                            <table>
                                    <th style="text-align: left"><label for="TY">Trích yếu</label></th>
...
-->
                        <table>
                             <tr>
                                    ...
                                    <td style="text-align: right; padding-left: 10px;"><input type="radio" name="add"</td>
                                    <th style="text-align: left"><label for="CGQ">Chưa giải quyết</label></th>
                                    <td style="text-align: right;padding-left: 10px;"><input type="radio" name="add"</td>
                                    <th style="text-align: left"><label for="DGQ">Đã giải quyết</label></th>
                                    <td style="text-align: right;padding-left: 10px;"><input type="radio" name="add"</td>
                                    <th style="text-align: left"><label for="DGQ1">Đang giải quyết</label></th>
                                </tr>		
                        </table>
                        </div>
                        <div class="group-button">
                                <button class="button" onclick="showForm('main-form', 'add-form', true)"><i class="fa fa-plus-circle"></i>&nbsp;Lưu lại</button>
                                <button type="reset" class="button"><i class="fa fa-refresh"></i>&nbsp;&nbsp;Nhập lại</button>
                                <button type="button" class="button" onclick="showForm('main-form', 'add-form', false)"><i class="fa fa-sign-out"></i>&nbsp;&nbsp;Thoát</button>
                        </div>
...
-->
				...
				<div class="group-button">
						...
						<button type="reset" class="button"><i class="fa fa-refresh"></i>&nbsp;&nbsp;Nhập lại</button>
						<button type="button" class="button" onclick="showForm('main-form', 'update-form', false)"><i class="fa fa-sign-out"></i>&nbsp;&nbsp;Thoát</button>
				</div>			
</form>      
<!--    update-vat-tu    -->
         <form id="update-yc-vat-tu">
                ...
                <div class="group-button">
                           <button type="button" class="button"  onclick="showForm('update-yc-vat-tu', 'add-form-ycvt', true)"><i class="fa fa-plus-circle"></i>&nbsp;Thêm mới</button>
                        <button type="button" class="button" onclick="showForm('update-yc-vat-tu','update-form-ycvt', true)"><i class="fa fa-pencil fa-fw"></i>&nbsp;Sửa</button>
                                     <button class="button" onclick="return confirmDelete()"> <i class="fa fa-trash-o" ></i>&nbsp;&nbsp;Xóa</button>
                            <button type="reset" class="button"><i class="fa fa-refresh"></i>&nbsp;&nbsp;Nhập lại</button>
                            <button type="button" class="button" onclick="showForm('main-form', 'update-yc-vat-tu',false)"><i class="fa fa-sign-out"></i>&nbsp;&nbsp;Thoát</button>
                    </div>
                   </div>
				</div>	
        </form>
    			...
    			<form id="add-form-ycvt">
					<div class="input-table">
						<table>
							<div class="form-title"style="padding: 10px">Thêm yêu cầu vật tư</div>
							<tr>
								<th style="text-align: left"><label for="TKM">Tìm kiếm mã</label></th>
								<td><input name="" type="text" class="text" required autofocus size="2" maxlength="3" pattern="[a-zA-Z0-9]{3}" title="Mã mục đích chỉ gồm 3 ký tự, không chứ khoảng trắng và ký tự đặc biệt"></td>
								<td class="name" style="text-align: right"><input type="checkbox" name=""</td>
								<th style="text-align: left"><label for="TT">Theo tên</label></th>
							</tr>
							<tr>
								<th style="text-align: left"><label for="MVT">Mã vật tư</label></th>
								<td><input name="" size="3px" class="text" align=right type="text" class="text" required title="Mã vật tư không được để trống"></td>
							</tr>	
							<tr>
								<th style="text-align: left"><label for="MVT">Nơi sản xuất</label></th>
								<td>
                                    <select required title="Nơi sản xuất không được để trống">
					...
					<div class="group-button">
							...
							<button type="reset" class="button"><i class="fa fa-refresh"></i>&nbsp;&nbsp;Nhập lại</button>
							<button type="button" class="button" onclick="showForm('update-yc-vat-tu','add-form-ycvt', false)"><i class="fa fa-sign-out"></i>&nbsp;&nbsp;Thoát</button>
					</div>			
				</form>
				<form id="update-form-ycvt">
					<div class="input-table">
						<table>
							<div class="form-title"style="padding: 10px">Cập nhật yêu cầu vật tư</div>
							<tr>
								<th style="text-align: left"><label for="TKM">Tìm kiếm mã</label></th>
								<td><input name="" type="text" class="text" required autofocus size="2" maxlength="3" pattern="[a-zA-Z0-9]{3}" title="Mã mục đích chỉ gồm 3 ký tự, không chứ khoảng trắng và ký tự đặc biệt"></td>
								<td class="name" style="text-align: right"><input type="checkbox" name=""</td>
							...
							<tr>
								<th style="text-align: left"><label for="MVT">Mã vật tư</label></th>
								<td><input name="" size="3px" align=right class="text" type="text" class="text" required title="Mã vật tư không được để trống"></td>
							</tr>	
							<tr>
								<th style="text-align: left"><label for="MVT">Nơi sản xuất</label></th>
								<td>
					...
					<div class="group-button">
							<button class="button"><i class="fa fa-floppy-o"></i>&nbsp;Lưu lại</button>
							<button type="reset" class="button"><i class="fa fa-refresh"></i>&nbsp;&nbsp;Nhập lại</button>
							<button type="button" class="button" onclick="showForm('update-yc-vat-tu', 'update-form-ycvt',false)"><i class="fa fa-sign-out"></i>&nbsp;&nbsp;Thoát</button>
					</div>			
				</form>		
    </div>
				</div>
