function showForm(formId, check){
		...
		function preUpdateVt(formId, check){
			...
			if (vtMaList.length == 0)
				...
				$.ajax({
					url: "/QuanLyVatTuYeuCau/preEditVt.html",
					type: "GET",
					dataType: "JSON",
					data: {"vtId": vtId},
		...
		function confirmDelete(){
	 	 ...
	 	 function deleteVt(str) {
			...
			$.ajax({
				url: "/QuanLyVatTuYeuCau/deleteVt.html",	
			  	type: "GET",
			  	dateType: "JSON",
			  	data: { "vtList": str},
			  	contentType: 'application/json',
 	 	...
 	 	function addVt() {
 			...
 			if(vtId == '') {
 			...
 			else if (vtTen == '')
	 			{
		 			...
		 			$.ajax({
		 				url: "/QuanLyVatTuYeuCau/addVt.html",	
					  	type: "GET",
		 			  	dateType: "JSON",
 	 		...
 	 		if (vtTenUpdate == '')
	 			{
					...
					$.ajax({
						url: "/QuanLyVatTuYeuCau/updateVt.html",	
					  	type: "GET",
					  	dateType: "JSON",
 	 	...
 	 	function changeVtId(){
 	  	...
 	  	$(document).ready(function() {
 			...
 			var pageNumber = $(this).val();
 		    	$.ajax({
 					url: "/QuanLyVatTuYeuCau/loadPageVt.html",	
 				  	type: "GET",
 				  	dateType: "JSON",
