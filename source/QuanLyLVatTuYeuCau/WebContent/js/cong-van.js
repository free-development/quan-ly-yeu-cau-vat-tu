...
function preUpdateCv(cv) {
	$.ajax({
		url: "/QuanLyVatTuYeuCau/preUpdateCv.html",	
	  	type: "GET",
	  	dateType: "JSON",
	  	data: { "congVan": cv},
...
function deleteCv(cvId) {
	$.ajax({
		url: "/QuanLyVatTuYeuCau/deleteCv.html",	
	  	type: "GET",
	  	dateType: "JSON",
	  	data: { "cvId": cvId},
	  	contentType: 'application/json',
...
//	var cvId = $('input:checkbox[name=cvId]:checked').val();
		...
		$.ajax({
			url: "/QuanLyVatTuYeuCau/chiaSeCv.html",	
		  	type: "GET",
		  	dateType: "JSON",
		  	data: { "cvId": cvId},
		  	contentType: 'application/json',
...
$(document).ready(function() {
		...
		var pageNumber = $(this).val();
	    	$.ajax({
				url: "/QuanLyVatTuYeuCau/loadPageCv.html",	
			  	type: "GET",
			  	dateType: "JSON",
...
//	var cvId = $('input:checkbox[name=cvId]:checked').val();
//	$.ajax({
//		url: "/QuanLyVatTuYeuCau/preEditCongVan.html",	
//	  	type: "GET",
//	  	dateType: "JSON",
//	  	data: { "cvId": cvId},
//	  	contentType: 'application/json',
