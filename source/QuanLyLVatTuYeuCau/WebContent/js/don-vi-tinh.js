function showForm(formId, check){
		...
		function preUpdatedvt(formId, check){
			...
			if (dvtMaList.length == 0)
				...
				$.ajax({
					url: "/QuanLyVatTuYeuCau/preEditdvt.html",
					type: "GET",
					dataType: "JSON",
					data: {"dvtId": dvtId},
		...
		function confirmDelete(){
	 	 ...
	 	 function deletedvt(dvtId) {
			...
			$.ajax({
				url: "/QuanLyVatTuYeuCau/deletedvt.html",	
			  	type: "GET",
			  	dateType: "JSON",
			  	data: { "dvtId": dvtId},
			  	contentType: 'application/json',
 			 ...
 			 if (dvtTen == '')
	 			{
		 			...
		 			$.ajax({
		 				url: "/QuanLyVatTuYeuCau/adddvt.html",	
					  	type: "GET",
		 			  	dateType: "JSON",
		 			  	data: {"dvtTen": dvtTen},
		 			  	contentType: 'application/json',
 	 		...
 	 		if (dvtTenUpdate == '')
	 			{
					...
					$.ajax({
						url: "/QuanLyVatTuYeuCau/updatedvt.html",	
					  	type: "GET",
					  	dateType: "JSON",
...
// 	 	} 	
 	  	...
 	  	$(document).ready(function() {
 			...
 			var pageNumber = $(this).val();
 		    	$.ajax({
 					url: "/QuanLyVatTuYeuCau/loadPagedvt.html",	
 				  	type: "GET",
 				  	dateType: "JSON",
