function showForm(formId, check){
	...
	function preUpdateMd(formId, check) {
		...
		$.ajax({
			url: "/QuanLyVatTuYeuCau/preUpdateMd.html",	
		  	type: "GET",
		  	dateType: "JSON",
		  	data: { "mdMa": mdMa},
	...
	function confirmDeleteMd(){
 	 ...
 	 function deleteMd(str) {
 		$.ajax({
			url: "/QuanLyVatTuYeuCau/deleteMd.html",	
		  	type: "GET",
		  	dateType: "JSON",
		  	data: { "mdList": str},
		  	contentType: 'application/json',
 	...
 	function addMd() {
		...
		$.ajax({
			url: "/QuanLyVatTuYeuCau/addMd.html",	
		  	type: "GET",
		  	dateType: "JSON",
 	...
 	function updateMd(mdMaUpdate, mdTenUpdate) {
		...
		$.ajax({
			url: "/QuanLyVatTuYeuCau/updateMd.html",	
		  	type: "GET",
		  	dateType: "JSON",
 	...
 	$(document).ready(function() {
 		...
 		var pageNumber = $(this).val();
 	    	$.ajax({
 				url: "/QuanLyVatTuYeuCau/loadPageMd.html",	
 			  	type: "GET",
 			  	dateType: "JSON",
