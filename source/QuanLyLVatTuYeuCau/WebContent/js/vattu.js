		...
		function timKiemVattu(){
			...
			*/
			$.ajax({
				url: "/QuanLyVatTuYeuCau/timKiemVattu.html",	
			  	type: "GET",
 			  	dateType: "JSON",
		...
		function addVattu() {
 			...
 			if(vtMa == '') {
 			...
 			else if(dvt == '')
 				{
		 			...
		 			$.ajax({
		 				url: "/QuanLyVatTuYeuCau/addVattu.html",	
					  	type: "GET",
		 			  	dateType: "JSON",
		...
		function preEditVattu(formId, check){
			...
			if (vtMaList.length == 0)
				...
				$.ajax({
					url: "/QuanLyVatTuYeuCau/preEditVattu.html",
					type: "GET",
					dataType: "JSON",
					data: {"vtMa": vtMa},
					contentType: "application/json",
 		...
 		function updateVattu(vtMaUpdate, vtTenUpdate, dvtUpdate){
 			...
 			if (vtTenUpdate == '')
 			...
 			else if(dvtUpdate == '')
 				{
		 			...
		 			$.ajax({
						url: "/QuanLyVatTuYeuCau/updateVattu.html",	
					  	type: "GET",
					  	dateType: "JSON",
 	...
 	function confirmDeleteVT(){
 		vtMa = $('input:checkbox[name=vtMa]:checked').val();	
 		$.ajax({
 			url: "/QuanLyVatTuYeuCau/comfirmdeleteVattu.html",	
 		  	type: "GET",
 		  	dateType: "JSON",
 		  	data: { "vtMa": vtMa},
 		  	contentType: 'application/json',
  	 ...
  	 function deleteVattu(str) {
 		...
 		$.ajax({
 			url: "/QuanLyVatTuYeuCau/deleteVattu.html",	
 		  	type: "GET",
 		  	dateType: "JSON",
 		  	data: { "vtList": str},
		  	contentType: 'application/json',
  	...
  	function showCTVatTu(formId, check, vtMa){ 
  		...
  		$.ajax({
  			url: "/QuanLyVatTuYeuCau/showCTVatTu.html",
			type: "GET",
		  	dateType: "JSON",
		  	data: {"vtMa": vtMa},
		  	contentType: 'application/json',
...
//					else alert("2");
    ...
    $(document).ready(function() {
 		...
 		var pageNumber = $(this).val();
 	    	$.ajax({
 				url: "/QuanLyVatTuYeuCau/loadPageVatTu.html",	
 			  	type: "GET",
 			  	dateType: "JSON",
