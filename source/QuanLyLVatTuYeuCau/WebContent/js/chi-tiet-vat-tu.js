		...
		function addCTVattu() {
 			...
 			$.ajax({
 				url: "/QuanLyVatTuYeuCau/addCTVattu.html",	
			  	type: "GET",
 			  	dateType: "JSON",
		...
		function preEditCTVattu(formId, check){
			...
			//alert(ctvtId);
				$.ajax({
					url: "/QuanLyVatTuYeuCau/preEditCTVattu.html",
					type: "GET",
					dataType: "JSON",
					data: {"ctvtId": ctvtId},
					contentType: "application/json",
...
//					  	$('#chatluongUp option[value='+vt.chatLuong.clMa+']').prop('selected',true);
		...
		function confirmUpdateCTVattu(){
 		...
 		function updateCTVattu(vtMaUpdate, vtTenUpdate, dvtUpdate, nsxUpdate, clUpdate, dinhMucUpdate, soLuongTonUpdate){
 			$.ajax({
				url: "/QuanLyVatTuYeuCau/updateCTVattu.html",	
			  	type: "GET",
			  	dateType: "JSON",
 	...
 	function confirmDeleteCTVT(){
  	...
  	///	alert(str); 
 		$.ajax({
 			url: "/QuanLyVatTuYeuCau/deleteCTVattu.html",	
 		  	type: "GET",
 		  	dateType: "JSON",
 		  	data: { "ctvtList": str},
		  	contentType: 'application/json',
    ...
    $(document).ready(function() {
 		...
 		var pageNumber = $(this).val();
 	    	$.ajax({
 				url: "/QuanLyVatTuYeuCau/loadPageCtvt.html",	
 			  	type: "GET",
 			  	dateType: "JSON",
