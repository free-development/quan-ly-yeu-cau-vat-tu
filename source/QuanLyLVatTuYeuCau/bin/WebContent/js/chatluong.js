 function showForm(formId, check){
	...
	function preUpdateCl(formId, check) {
		...
		$.ajax({
			url: "/QuanLyVatTuYeuCau/preUpdateCl.html",	
		  	type: "GET",
		  	dateType: "JSON",
		  	data: { "clMa": clMa},
	...
	function confirmDeleteCl(){
 	 ...
 	 function deleteCl(str) {
		$.ajax({
			url: "/QuanLyVatTuYeuCau/deleteCl.html",	
		  	type: "GET",
		  	dateType: "JSON",
		  	data: { "clList": str},
		  	contentType: 'application/json',
 	...
 	function addCl() {
		...
		if(clMa == '') 
			...
			$.ajax({
				url: "/QuanLyVatTuYeuCau/addCl.html",	
			  	type: "GET",
			  	dateType: "JSON",
 	...
 	function updateCl(clMaUpdate, clTenUpdate) {
		...
		$.ajax({
			url: "/QuanLyVatTuYeuCau/updateCl.html",	
		  	type: "GET",
		  	dateType: "JSON",
 	...
 	$(document).ready(function() {
 		...
 		var pageNumber = $(this).val();
 	    	$.ajax({
 				url: "/QuanLyVatTuYeuCau/loadPageCl.html",	
 			  	type: "GET",
 			  	dateType: "JSON",
