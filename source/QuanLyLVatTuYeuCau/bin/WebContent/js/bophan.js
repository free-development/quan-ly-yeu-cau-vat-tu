function showForm(formId, check){
		...
		function addBp() {
 			...
 			else if (email == '')
 			{
 				$('#requireEmail').html('Vui lòng nhập email');
		 			...
		 			$.ajax({
		 				url: "/QuanLyVatTuYeuCau/addBp.html",	
					  	type: "GET",
		 			  	dateType: "JSON",
		...
		function preUpdateBp(formId, check){
			...
			if (dvMaList.length == 0)
				...
				$.ajax({
					url: "/QuanLyVatTuYeuCau/preEditBp.html",
					type: "GET",
					dataType: "JSON",
					data: {"dvMa": dvMa},
					contentType: "application/json",
 	 	...
 	 	function updateBp(dvMaUpdate, dvTenUpdate, sdtUpdate, diaChiUpdate, emailUpdate) {
			...
			else if (emailUpdate == '')
			{
				$('#requireEmailUp').html('Vui lòng nhập email');
					...
					$.ajax({
						url: "/QuanLyVatTuYeuCau/updateBp.html",	
					  	type: "GET",
					  	dateType: "JSON",
		...
		function confirmDelete(){
	 	 ...
	 	 function deleteBp(str) {
			...
			$.ajax({
				url: "/QuanLyVatTuYeuCau/deleteBp.html",	
			  	type: "GET",
			  	dateType: "JSON",
			  	data: { "dvList": str},
			  	contentType: 'application/json',
 	 	...
 	 	function changeSdtUp(){
 	  	...
 	  	$(document).ready(function() {
 	 		...
 	 		var pageNumber = $(this).val();
 	 	    	$.ajax({
 	 				url: "/QuanLyVatTuYeuCau/loadPageDv.html",	
 	 			  	type: "GET",
 	 			  	dateType: "JSON",
