		...
		<div class="main_menu">
			<ul>
				...
				<li><a href="<%=siteMap.cscvManage +  "?action=manageCscv"%>">Chia
						sẽ</a></li>
				<li><a href="<%=siteMap.ndManage + "?action=ndmanage"%>">Quản
						lý người dùng</a></li>
			</ul>
			<div class="clear"></div>
		</div>

		<div id="title-content">Tạo tài khoản</div>
		<div id="main-content">
			<form action="<%=siteMap.ndManage %>?action=AddNd" method="post"
				name="taoTaiKhoan" action="/QuanLyVatTu/manageNd.html">
				<table>
					<tr>
					...
					<tr>
						...
						<td><input type="password" required size="20" maxlength="20"
							title="Mật khẩu phải hơn 7 ký tự và nhỏ hơn 21" pattern=".{8,20}"
							class="text" id="nlmatkhau" name="re-matkhau"></td>
					</tr>
					...
					<tr>
						...
						<td><input type="email" required size="20" maxlength="50"
