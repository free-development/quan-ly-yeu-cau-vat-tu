			...
			<ul>
				...
				<li><a href="">Danh mục</a>
					<ul>
						...
						<li><a href="<%=siteMap.clManage +  "?action=manageBpsd"%>">Danh
...
<!-- 					<input type="hidden" name="action" value="deleteCd"> -->
					...
					&nbsp;&nbsp;
					<button type="button" class="button"
						onclick="preUpdateCd('update-form', true)"
						title="Chọn 1 chức danh để thay đổi">
					...
					<table>
						...
						<tr>
							...
							<td><input name="cdMaUpdate" type="text" class="text"
								...
								pattern="[a-zA-Z0-9]{3}"
								title="Mã chức danh chỉ gồm 3 ký tự, không chứ khoảng trắng và ký tự đặc biệt"></td>
						</tr>
						<tr>
							<td class="input"><label for="TCD">Tên chức danh</label></td>
...
<!-- 					<input type="hidden" name="action" value="UpdateCd"> -->
					<button class="button" type="button" onclick="confirmUpdateCd()">
